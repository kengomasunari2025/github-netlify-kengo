    ...
    switch (e.tag) {
      case 3:
        ...
        if (n.current.memoizedState.isDehydrated) {
          ...
          t !== 0 &&
            (Gl(n, t | 1), De(n, ue()), !(U & 6) && ((It = ue() + 500), Bn()));
        }
        break;
      case 13:
        st(function () {
...
const Bd = ({ isOpen: j, closeModal: k }) => (
    ct.useEffect(() => {
      ...
      if (
        ...
        ae.forEach((I) => {
          I.addEventListener("click", () => {
            let H = I.closest(".light-box-popup");
  ...
  Mf = "assets/lessonOne-close-CrBiiPT9.png",
  Ff = () => {
    const j = { fontSize: "11px", lineHeight: "14px" },
      k = me[13];
    return s.jsxs("div", {
  ...
  bf = () => {
    ...
    return s.jsx("div", {
      ...
      children: s.jsx("div", {
        ...
        children: s.jsx("h2", {
          className: "copy",
          children: s.jsx("p", { ref: ae, style: H, children: j }),
        }),
      }),
    });
  },
